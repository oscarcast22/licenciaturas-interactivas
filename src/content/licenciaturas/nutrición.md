...
plan_estudios:
  ...
  - titulo: Segundo Bloque
    contenido: ["Nutrición II", "Fundamentos Pedagógicos y Didácticos", "Fisiología II", "Bioquímica II", "Nutrición en el Ciclo de Vida", "Sociología"] 
  - titulo: Tercer Bloque
    contenido: ["Fisiopatología I", "Bromatología I", "Administración Básica", "Hábitos Alimentarios Nacionales e Internacionales", "Bromatología II", "Sistemas de Producción de Alimentos"] 
  - titulo: Cuarto Bloque
    contenido: ["Dietética", "Fisiopatología II", "Microbiología", "Higiene de los Alimentos", "Métodos de Evaluación del Estado Nutrición", "Cálculo en Dietética"]
  ...
  - titulo: Noveno Bloque
    contenido: ["Seminario de Investigación II", "Dietas Alternativas", "Administración de Recursos Humanos en Nutrición", "Gerencia en Nutrición", "Suplementos y Complementos Alimenticios", "Manejo de Software en Nutrición"]
---
